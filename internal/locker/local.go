...
// LocalLocker 基于文件锁的本地互斥锁，适用于单机多进程。
//
...
//
// 返回:
//   - *LocalLocker: 文件锁实例，已准备好使用。
func NewLocalLocker(lockPath string) (*LocalLocker, error) {
...
func (l *LocalLocker) TryLock() (bool, error) {
